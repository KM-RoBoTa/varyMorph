...
class Population:
    def __init__(self, size, decision_var, output_dir='generations'):
        self.size = size
        self.robots = {}
    ...
    def initialize_population(self):
        # Create a population of robots, based on the mode of the evolution 
        if config.MORPHOLOGY == "quadruped":
