...
def sample_from_range(range_, rng_state=None):
    """Randomly sample a value from the list specified by range_. the range is
    [start, end, step]. If the range is a single value, return that value."""
...
range_ = [0, 30, 1]
print(sample_from_range(range_)) # 30

# test sample_from_list
list_ = [0, 30, 60]
print(sample_from_list(list_)) # 60

# test sample_range_from_range
range_ = [0, 30, 1]
print(sample_range_from_range(range_)) # [0, 30]

# test sample_joint_angle
range_ = [0, 30, 1]
print(sample_joint_angle(range_)) # [0, 30]

# test sample_joint_angle_from_list
list_ = [0, 30, 60]
print(sample_joint_angle_from_list(list_)) # 30
