...
from morphGen.utils.link import *
from robot_builder.urdf_generator import *
...
def create_box_link(id, shape_type, link_name, **kwargs):
    ...
    if relative_com_pos != 0.5:
        Ixx, Iyy, Izz = updated_inertia(relative_com_pos, box_link_inertia, box_link_position)
...
def create_cylinder_link(id, shape_type, link_name, **kwargs):
    ...
    if relative_com_pos != 0.5:
        Ixx, Iyy, Izz = updated_inertia(relative_com_pos, cylinder_link_inertia, cylinder_link_position)
